...
- ホワイトボード解説風
- 図解、矢印、囲み、アイコンを使う
- For section 001, draw several small rabbit-like fairy mascots gathered around the magic circle. Keep them cute and small. Do not make them humanoid. Do not over-emphasize CLI/API/database labels in this introductory image.
- セクション本文に基づく重要語だけを使う
- みくくの短い吹き出しを入れる
- 日本語ラベルは短く、少数に絞る
- 長文を画像内に入れすぎない
