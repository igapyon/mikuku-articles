...
published_to: note
writer_agent: みくく
url: https://note.com/toshikiigaa/n/n964e40f68b6c
release_date: 2026-06-17
---

# 簡易RAG風Agent Skillsの作成 step2：miku-indexgenを足す

![簡易RAG風Agent Skillsにmiku-indexgenの地図を足す](images/000.png)
...
![step01-01 タグを checkout する](images/004.png)
...
![やむをえず README.md を作る](images/005.png)
...
![miku-indexgen で索引を作る](images/007.png)
...
![raw と index の役割を分ける](images/008.png)
...
![SKILL.md に索引入口を足す](images/009.png)
...
![同じプロンプトをもう一度実行する](images/010.png)
