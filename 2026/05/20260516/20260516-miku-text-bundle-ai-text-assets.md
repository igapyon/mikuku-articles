...
![miku-text-bundle: 複数のテキストファイルを生成AI向け Markdown bundle に整理する](images-miku-text-bundle-ai-text-assets/000.png)

## はじめに

![はじめに](images-miku-text-bundle-ai-text-assets/001.png)
...
![ファイルを 1 つずつ渡すのは、意外とつらい](images-miku-text-bundle-ai-text-assets/002.png)
...
![miku-text-bundle がすること](images-miku-text-bundle-ai-text-assets/003.png)
...
![index と prompt がある](images-miku-text-bundle-ai-text-assets/004.png)
...
![context window を広げるツールではない](images-miku-text-bundle-ai-text-assets/005.png)
...
![Node.js 用と Java 用がある](images-miku-text-bundle-ai-text-assets/006.png)
...
![対象を調整できる](images-miku-text-bundle-ai-text-assets/007.png)
...
![文字コードにも少し配慮できる](images-miku-text-bundle-ai-text-assets/008.png)
...
![どんな場面で使うのか](images-miku-text-bundle-ai-text-assets/009.png)
...
![制限回避ではなく、整理と選択のための道具](images-miku-text-bundle-ai-text-assets/010.png)
...
![まとめ](images-miku-text-bundle-ai-text-assets/011.png)
